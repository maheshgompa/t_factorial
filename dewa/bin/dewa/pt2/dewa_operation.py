...
from models.pt2 import production as production_models
from models.pt2 import raw as raw_models
    ...
    def perform_calculation(self, selected_date):
        ...
        try:
            initial_df = self.raw_models.KKSDescription.get_kkses_df(
                [ ('22wta07aa201', '22wta07aa201'),  ('22wta07aa202', '22wta07aa202'),  
                  ('22wta07aa203', '22wta07aa203'),  ('22wta07aa204', '22wta07aa204'),  
                  ('22wtu01cp901', '22wtu01cp901')
                   ],
                selected_date,
        ...
        initial_df.loc[((initial_df['22wta07aa201'] >= 1) | (initial_df['22wta07aa202'] >= 1) | 
                (initial_df['22wta07aa203'] >= 1) | (initial_df['22wta07aa204'] >= 1)) & (
                initial_df['22wtu01cp901'] >= 0.3), 'operation'] = 'ON'
                    
        self.production_models.UllageOperation.write_df(
            initial_df.loc[:, ['22wta07aa201', '22wta07aa202', '22wta07aa203', '22wta07aa204',
                '22wtu01cp901', 'operation']],
