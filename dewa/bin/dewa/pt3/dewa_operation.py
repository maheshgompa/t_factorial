...
from models.pt3 import production as production_models
from models.pt3 import raw as raw_models
    ...
    def perform_calculation(self, selected_date):
        ...
        try:
            initial_df = self.raw_models.KKSDescription.get_kkses_df(
                [ ('32wta07aa201', '32wta07aa201'),  ('32wta07aa202', '32wta07aa202'),  
                  ('32wta07aa203', '32wta07aa203'),  ('32wta07aa204', '32wta07aa204'),  
                  ('32wtu01cp901', '32wtu01cp901')
                   ],
                selected_date,
        ...
        initial_df.loc[((initial_df['32wta07aa201'] >= 1) | (initial_df['32wta07aa202'] >= 1) | 
                (initial_df['32wta07aa203'] >= 1) | (initial_df['32wta07aa204'] >= 1)) & (
                initial_df['32wtu01cp901'] >= 0.3), 'operation'] = 'ON'
                    
        self.production_models.UllageOperation.write_df(
            initial_df.loc[:, ['32wta07aa201', '32wta07aa202', '32wta07aa203', '32wta07aa204',
                '32wtu01cp901', 'operation']],
    ...
    def write_raw_measures_and_set_alarms(self, selected_date):
        ...
        with Session(self.production_models.engine) as session:
            for sensor in session.scalars(select(self.production_models.UllageSensor)):
                ...
                # print(sensor_raw_df.index)
                while len(low_alarm_columns) > 1:
                    test_column = low_alarm_columns.pop(1)
