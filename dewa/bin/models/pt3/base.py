...
from config.pt3.config import RAW_DATABASE_CONNECTION, PRODUCTION_DATABASE_CONNECTION
...
class Common():
    ...
    def get_engine(cls):
        ...
        if cls.__module__ == 'models.pt3.production':
            return production_engine
        elif cls.__module__ == 'models.pt3.raw':
            return raw_engine
