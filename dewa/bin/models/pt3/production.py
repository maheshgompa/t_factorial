...
from models.pt3.base import BaseProduction as Base
from models.pt3.base import production_engine as engine
from models.pt3.base import reset_seconds_in_df_indexes
...
class UllageOperation(Base):
    ...
    write_df_to_db_constraint = 'dewa_operation_pkey'
...
class UllageRawMeasurement(Base):
    ...
    write_df_to_db_constraint = 'dewa_raw_measurement_pkey'
...
class UllageAlarmDefinition(Base):
    ...
    write_df_to_db_constraint = 'dewa_alarm_definition_pkey'
    write_df_to_db_constraint_fields = ['id']
